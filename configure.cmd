...
if "%BUILD_ENVIRONMENT%" == "MinGW" (
    ...
    "C:\Program Files\CMake\bin\cmake.exe" -G %CMAKE_GENERATOR% %CMAKE_ARCH% -DCMAKE_TOOLCHAIN_FILE:FILEPATH=toolchain-msvc.cmake -DARCH:STRING=%ARCH% %BUILD_TOOLS_FLAG% "%REACTOS_SOURCE_DIR%"
)
